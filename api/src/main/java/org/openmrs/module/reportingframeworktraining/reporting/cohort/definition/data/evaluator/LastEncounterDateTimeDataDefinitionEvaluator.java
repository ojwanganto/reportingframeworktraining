 ...
 */
public class LastEncounterDateTimeDataDefinitionEvaluator implements PatientDataEvaluator {
    ...
    public EvaluatedPatientData evaluate(PatientDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        Date lastEncounterEncounterDatetime = lastEncounter.getEncounterDatetime();

        if (context.getBaseCohort() != null) {
            for (Integer pId : context.getBaseCohort().getMemberIds()) {
                c.addData(pId, lastEncounterEncounterDatetime);
            }
        }
