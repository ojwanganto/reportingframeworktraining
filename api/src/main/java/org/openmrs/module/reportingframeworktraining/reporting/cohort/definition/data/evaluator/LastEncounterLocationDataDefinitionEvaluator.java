 ...
 */
public class LastEncounterLocationDataDefinitionEvaluator implements PatientDataEvaluator {
    ...
    public EvaluatedPatientData evaluate(PatientDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        Location lastEncounterLocation = lastEncounter.getLocation();


        if (context.getBaseCohort() != null) {
            for (Integer pId : context.getBaseCohort().getMemberIds()) {
                c.addData(pId, lastEncounterLocation.getName());
            }
        }
